...
class TestClaudeAPIIntegration(unittest.TestCase):
    ...
    def test_claude_api_call(self, mock_anthropic):
        ...
        mock_response.content = [MagicMock(text="I will do my best to provide a helpful response to your prompt! Feel free to provide more details or context about what specifically you would like me to test or assist with.")]
        mock_client.messages.create.return_value = mock_response

        response = self.claude_manager.generate_response("Test prompt")
        
        self.assertEqual(response, "I will do my best to provide a helpful response to your prompt! Feel free to provide more details or context about what specifically you would like me to test or assist with.")
